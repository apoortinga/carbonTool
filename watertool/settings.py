...
"""
Django settings for watertool project.
...
SECRET_KEY = '3!cue9=gkejcbg-av1c+2rdn8+-+4@f*7pycl2e9c^^vptx6%r'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = ['198.167.239.9','localhost']
...
ROOT_URLCONF = 'watertool.urls'



WSGI_APPLICATION = 'watertool.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'watertool', 'templates'),],
        'OPTIONS': {
            'context_processors': [
...
def MakeWaterMap(request):
	...
	mapid = surfacewater.WaterMap(startDate,endDate	)
...
def showSentinel(request):


	mapid = surfacewater.getSentinel()
